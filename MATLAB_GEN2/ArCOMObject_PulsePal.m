...
classdef ArCOMObject_PulsePal < handle
    properties
        Port
        baudRate
        Interface
    ...
    methods
        function obj = ArCOMObject_PulsePal(portString, baudRate, varargin)
            obj.Port = [];
            ...
            switch obj.Interface
                ...
                case 1
                    ...
                    if (obj.Port < 0)
                        ...
                        error(['Error: Unable to connect to port ' portString '. The port may be in use by another Pulse Pal object or application.'])
                    end
